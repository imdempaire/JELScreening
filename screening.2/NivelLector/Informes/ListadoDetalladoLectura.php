...
$sql_grados = "SELECT DISTINCT grado FROM screening_lectura WHERE colegio = '$nombre_colegio'";
...
$sql_trimestres = "SELECT DISTINCT trimestre FROM screening_lectura WHERE colegio = '$nombre_colegio'";
...
$sql_anios = "SELECT DISTINCT anio FROM screening_lectura WHERE colegio = '$nombre_colegio'";
    ...
    <table>
        <thead>
            <tr>
                ...
                <th><center>Nivel<br>Lector<br>General</center></th>
                <th><center>Decodificacion -<br>Compresion<br>Simple</center></th>
                <th><center>Comprension<br>deductiva<br> o compleja</center></th>
                <th><center>Contenido<br>y vocabulario</center></th>
                <th><center>Dominio de<br>marcadores<br>del discurso</center></th>
            ...
            <?php if ($result->num_rows > 0): ?>
                <?php while ($row = $result->fetch_assoc()): ?>
                    <tr>
                        ...
                        <td><?php echo htmlspecialchars($row['BienDeco']); ?></td>
                        <td><?php echo htmlspecialchars($row['BienConec']+$row['BienCont']); ?></td>
                        <td><?php echo htmlspecialchars($row['BienCont']); ?></td>
                        <td><?php echo htmlspecialchars($row['BienConec']); ?></td>
