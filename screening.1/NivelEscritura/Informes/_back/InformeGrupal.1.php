<?php
// Objetivo: Mostrar un gráfico de barras con el total de puntos por grado de un colegio
...
$sql = "SELECT grado, SUM(total_puntos) as total_puntos FROM evaluaciones WHERE colegio = '$nombre_colegio' GROUP BY grado";
...
<body>
    ...
    <script>
        ...
        const totalPuntos = <?php echo json_encode($total_puntos); ?>;
        ...
        const myChart = new Chart(ctx, {
            ...
            data: {
                labels: grados,
                datasets: [{
                    label: 'Total de Puntos por Grado',
                    data: totalPuntos,
