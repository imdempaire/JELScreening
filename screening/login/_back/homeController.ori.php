<?php
    class homeController{
        ...
        public function guardarUsuario($nombre, $correo,$contraseña,$colegio,$tipo,$pais,$provincia,$localidad){
            // Le saco el encriptado para grabar la contraseña
            // $valor = $this->MODEL->agregarNuevoUsuario($nombre,$this->limpiarcorreo($correo),$this->encriptarcontraseña($this->limpiarcadena($contraseña)),$colegio,$tipo,$pais,$provincia,$localidad);
            $valor = $this->MODEL->agregarNuevoUsuario($nombre,$this->limpiarcorreo($correo),$contraseña,$colegio,$tipo,$pais,$provincia,$localidad);
            return $valor;
        }
