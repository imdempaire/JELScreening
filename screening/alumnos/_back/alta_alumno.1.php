...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO alumnos (id_estudiante, nombre, apellido, grado, division, id_colegio, fecha_nacimiento, sexo, dificultad_escritura, dificultad_lectura, dificultad_matematica, observaciones) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
